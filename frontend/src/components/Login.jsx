...
// Google Sign-In shows full-screen loading overlay while OAuth is pending
...
export function Login() {
    ...
    const handleGoogleSignIn = async () => {
        try {
            ...
            // Keep loading=true — the useEffect redirect will unmount us
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#0a0a0a]">
            {/* Full-screen overlay while Google OAuth is pending */}
            <AnimatePresence>
                {loading && (
                    <motion.div
                        key="google-loading"
                        ...
                        className="fixed inset-0 z-[9999] bg-[#050505] flex flex-col items-center justify-center gap-5"
                    >
                        {/* Google logo */}
                        ...
                        {/* Spinner — reliable CSS animation instead of framer */}
                        <svg
                            className="animate-spin w-8 h-8 text-white/30"
                        ...
                        <div className="text-center">
                            <p className="text-white font-semibold text-base tracking-tight">Signing in with Google</p>
                            <p className="text-white/30 text-sm mt-1">Complete the sign-in in the popup window</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <PublicNavbar />
            <div className="flex-1 flex items-center justify-center px-4 py-12 pt-20 md:pt-24">
                <motion.div
