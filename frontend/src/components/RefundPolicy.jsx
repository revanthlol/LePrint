    ...
    <div className="min-h-screen flex flex-col bg-[#0a0a0a]">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 md:px-6 pt-32 pb-20">
        ...
        <div className="md:bg-white/[0.03] md:backdrop-blur-2xl md:border md:border-white/[0.05] md:rounded-[2.5rem] md:shadow-2xl md:shadow-black/50 md:p-16">
          ...
          <div className="mb-12 md:p-8 bg-white/[0.02] md:rounded-3xl md:border md:border-white/[0.05]">
            <p className="text-[10px] uppercase font-bold tracking-[0.2em] text-muted-foreground/60 mb-6 px-1">Quick Reference Guide</p>
            <div className="overflow-x-auto -mx-4 md:mx-0 rounded-2xl border border-white/[0.05] bg-[#0c0c0c]/50">
